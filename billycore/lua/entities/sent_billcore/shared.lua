...
ENT.Base 		= "base_core3"
ENT.PrintName		= "Billy Core" -- The name the Core will come up as in the Spawnmenu
...
ENT.Animation		= "core01_idle" -- Set's the animation of the core, a list can be found here: http://pastebin.com/SAHyMZ3k
ENT.Delay		= 5 -- Delay in seconds between each sound the core makes (excluding 'special' sounds)
ENT.Dir			= "bill" -- The name of your sub-folder, must be 4 characters.
/*---------------------------------------------------------
